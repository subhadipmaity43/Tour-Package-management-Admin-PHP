...
if(isset($_POST['search']))
{
        ...
        $condition .= "and (name LIKE '%$ser%' OR  email LIKE '%$ser%'  OR massage LIKE '%$ser%') ";
...
$sql = "select * from contact ".$condition;
...
<div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h3 class="title-1">Contact information :</h3>
            ...
            ?>                
                                    ...
                                    <td>
                                    <a href="messege.php?contactid=<?php echo $id; ?>">
