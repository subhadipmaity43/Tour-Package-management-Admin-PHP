                    ...
                    if(isset($_POST['name']))
                    {
                            ...
                            if( $_FILES['photo']['name']!="")
                            {
                             ...
                             $pname=  str_replace(" ","_",$name).rand(1,1000).".".$ex; 
                              ...
                              $sql = "update package set name='$name',package='$package',price='$price',description='$description',photo='$pname' where id='$eidtid' ";
  
                              mysqli_query($con,$sql);
                            }
                            else
                            {
                              $sql = "update package set name='$name',package=$package,price='$price',description='$description'  where id='$eidtid' ";
                        ...
                        <div class="card-body">
                           <form class="form-parsley" action="" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group"><label>Name</label>
                               ...
                               <input type="text" class="form-control" name="name" value="<?php echo  $row['name']?>" required placeholder="Package Name">
                               
                               </div>

                               <div class="form-group"><label>Package</label>
                              
                              <input type="text" class="form-control" name="package" value="<?php echo  $row['package']?>" required placeholder="Package">
                               ...
                               <input type="text" class="form-control" name="price" value="<?php echo  $row['price']?>" required placeholder="Price">
                              ...
                              <div class="form-group">
                                 ...
                                 <div><input type="text" name="description" value="<?php echo  $row['description']?>" class="form-control" required  placeholder="Enter description" /></div>
                              </div>
