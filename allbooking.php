...
if(isset($_POST['search']))
{
        ...
        $condition .= "and (fname LIKE '%$ser%' OR lname LIKE '%$ser%' OR booking_date LIKE '%$ser%' OR total_person LIKE '%$ser%' OR phoneno LIKE '%$ser%' OR emailid LIKE '%$ser%' OR package LIKE '%$ser%'
        OR name LIKE '%$ser%' OR amount LIKE '%$ser%' OR trasactionid LIKE '%$ser%' OR paymentdate LIKE '%$ser%' OR status LIKE '%$ser%') ";
...
$sql = "select * from payment ".$condition;
...
<div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h3 class="title-1">Booking Details :</h3>
